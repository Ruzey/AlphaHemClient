...
namespace AlphaHemClient.Model.ViewModel
{
    ...
    public class RealtorRegisterVM
    {
        ...
        [EmailAddress(ErrorMessage = "Ogiltig epost.")]
        ...
        [Compare("Password", ErrorMessage = "Dina lösenord matchar inte.")]
        ...
        [Required(ErrorMessage = "Vänligen fyll i ett giltigt telefonnummer.")]
